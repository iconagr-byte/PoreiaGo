...
' *************************************************************************
strIncServerAddress	   = "mail.achilliotravel.com"		 					' This is the address for the mail server
strOutServerAddress	   = "mail.achilliotravel.com"		 					' This is the address for the mail server
strServerMailPort 	   = "000003e3"							' The port on the server to which to connect
																' Imap:  Secure = 000003e1  Unsecure = 0000008f
																' Pop:   Secure = 000003e3	Unsecure = 0000006e
strAccount			   = "info@achilliotravel.com"							' Mail account to connect as
...
boolPop				   = True							' Whether to setup Imap or Pop
