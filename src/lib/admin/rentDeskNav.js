...
export const RENT_DESK_TABS = [
  ...
  { id: 'availability', label: 'Διαθεσιμότητα /rent', icon: 'event_available' },
  { id: 'documents', label: 'Έγγραφα /rent', icon: 'folder_managed' },
  { id: 'expenses', label: 'Έξοδα /rent', icon: 'local_gas_station' },
