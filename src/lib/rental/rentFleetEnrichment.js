...
const BY_MODEL = {
  ...
  'peugeot 208': {
    headline: 'Μικρομεσαίο hatchback 2026',
    blurb:
      'Μοντέλο 2026 — μικρομεσαίο hatchback για καθημερινές διαδρομές και κοντινές αποδράσεις. Άνετη καμπίνα, κλιματισμός και χαμηλή κατανάλωση.',
    transmission: 'Χειροκίνητο',
    fuel: 'Βενζίνη',
    doors: 5,
    luggage: '2 βαλίτσες',
  ...
  'renault clio': {
    ...
    blurb:
      'Μοντέλο 2026 — μικρομεσαίο και οικονομικό επιβατικό για καθημερινές διαδρομές, πάρκινγκ και κοντινές αποδράσεις. Εύκολο στην οδήγηση, με χαμηλή κατανάλωση και άνεση για έως 5 επιβάτες.',
    transmission: 'Χειροκίνητο',
    fuel: 'Βενζίνη',
    doors: 5,
    luggage: '2 βαλίτσες',
  ...
  'citroen c3': {
    headline: 'Μικρομεσαίο hatchback',
    blurb:
      'Μικρομεσαίο hatchback για καθημερινές διαδρομές και κοντινές αποδράσεις. Άνετη καμπίνα, κλιματισμός και χαμηλή κατανάλωση.',
    transmission: 'Χειροκίνητο',
    fuel: 'Βενζίνη',
    doors: 5,
    luggage: '2 βαλίτσες',
  ...
  'toyota yaris': {
    ...
    blurb:
      'Μικρομεσαίο και οικονομικό επιβατικό για καθημερινές διαδρομές, πάρκινγκ και κοντινές αποδράσεις. Εύκολο στην οδήγηση, με χαμηλή κατανάλωση και άνεση για έως 5 επιβάτες.',
    transmission: 'Χειροκίνητο',
    fuel: 'Βενζίνη',
    doors: 5,
    luggage: '2 βαλίτσες',
