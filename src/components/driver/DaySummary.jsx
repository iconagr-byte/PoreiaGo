...
export default function DaySummary() {
  ...
  return (
    <div className="driver-stack driver-summary">
      <div className="text-center py-2">
        <p className="driver-card-label">Κρατήσεις</p>
        <h2 className="text-2xl font-extrabold tracking-tight mt-1">Κάτοψη & επιβίβαση</h2>
      </div>

      <div className="driver-summary-layout">
        {manifest ? (
          <div className="driver-card driver-summary-map">
        ...
        <div className="driver-summary-side">
          <div className="driver-summary-tiles">
            {tiles.map((t) => (
              <div
                key={t.label}
          ...
          <div className="driver-card">
            ...
            {boardedList.length === 0 ? (
              ...
              <ul className="mt-3 space-y-2 driver-passenger-list">
                {boardedList.map((p) => (
                  <li
